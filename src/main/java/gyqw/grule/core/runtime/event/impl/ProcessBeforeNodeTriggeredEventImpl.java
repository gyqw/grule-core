 ...
 * the License.
 ******************************************************************************/
package gyqw.grule.core.runtime.event.impl;

import gyqw.grule.core.model.flow.FlowNode;
import gyqw.grule.core.model.flow.ins.ProcessInstance;
import gyqw.grule.core.runtime.KnowledgeSession;
import gyqw.grule.core.runtime.event.ProcessBeforeNodeTriggeredEvent;
