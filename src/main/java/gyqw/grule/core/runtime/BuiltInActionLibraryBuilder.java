...
import gyqw.grule.core.model.library.action.annotation.ActionBean;
import gyqw.grule.core.model.library.action.annotation.ActionMethod;
import gyqw.grule.core.model.library.action.annotation.ActionMethodParameter;
...
public class BuiltInActionLibraryBuilder implements ApplicationContextAware{
	...
	private List<gyqw.grule.core.model.library.action.Method> buildMethod(Method[] methods){
		List<gyqw.grule.core.model.library.action.Method> list=new ArrayList<gyqw.grule.core.model.library.action.Method>();
		for(Method m:methods){
			ActionMethod methodAnnotation=m.getAnnotation(ActionMethod.class);
			if(methodAnnotation==null)continue;
			String name=methodAnnotation.name();
			String methodName=m.getName();
			gyqw.grule.core.model.library.action.Method libMethod=new gyqw.grule.core.model.library.action.Method();
