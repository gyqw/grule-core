...
public class BuildUtils {
	public static AbstractValue buildValue(RuleParserParser.ComplexValueContext context){
		...
		if(context.leftParen()!=null){
			...
			RuleParserParser.MethodInvokeContext actionContext=(RuleParserParser.MethodInvokeContext)context.methodInvoke();
		...
		if(arithList!=null && arithList.size()>0){
			...
			arith.setValue(buildValue((RuleParserParser.ComplexValueContext)nextContext));
